...
* Download the data package from github [Dropbox](https://www.dropbox.com/s/32gqppw9r6odm01/R4Oceanography.zip?dl=0). Move it to your Desktop folder and unzip it
...
```{r}
setwd("C:/Users/Desktop/R4Oceanography")
```
